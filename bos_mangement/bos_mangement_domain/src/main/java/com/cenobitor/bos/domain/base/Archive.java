...
public class Archive {
    ...
    private Set<com.cenobitor.bos.domain.base.SubArchive> subArchives = new HashSet<>(); // 子档案
    ...
    public Set<com.cenobitor.bos.domain.base.SubArchive> getSubArchives() {
        return subArchives;
    }

    public void setSubArchives(Set<com.cenobitor.bos.domain.base.SubArchive> subArchives) {
